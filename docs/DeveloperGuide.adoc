...
By: `Team T09-B3`      Since: `Sep 2017`      Licence: `MIT`
...
1. User inputs text to console to add person.
2. Address Book acknowledges and adds person to the list.
3. Address Book is updated with a latest list of persons.
+
Use case ends.
...
_(renamed from *Address Book* since  Mac OS X 10.8)_
